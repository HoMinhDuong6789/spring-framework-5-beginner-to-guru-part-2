...
public class Bootstrap implements ApplicationListener<ContextRefreshedEvent> {
    ...
    private List<Recipe> getRecipes() {
        ...
        guacamoleRecipe.getIngredients().add(new Ingredient("ripe avocados", new BigDecimal(2), pieceMeasure));
        guacamoleRecipe.getIngredients().add(new Ingredient("kosher salt", new BigDecimal(".5"), teapoonMeasure));
        guacamoleRecipe.getIngredients().add(new Ingredient("fresh lime juice or lemon juice", new BigDecimal(2), tableSpoonMeasure));
        guacamoleRecipe.getIngredients().add(new Ingredient("minced red onion or thinly sliced green onion", new BigDecimal(2), tableSpoonMeasure));
        guacamoleRecipe.getIngredients().add(new Ingredient("serrano chiles, stems and seeds removed, minced", new BigDecimal(2), pieceMeasure));
        guacamoleRecipe.getIngredients().add(new Ingredient("cilantro", new BigDecimal(2), tableSpoonMeasure));
        guacamoleRecipe.getIngredients().add(new Ingredient("freshly grated black pepper", new BigDecimal(2), dashMeasure));
        guacamoleRecipe.getIngredients().add(new Ingredient("ripe tomato, seeds and pulp removed, chopped", new BigDecimal(".5"), pieceMeasure));
        ...
        tacoRecipe.getIngredients().add(new Ingredient("ancho chili Powder", new BigDecimal(2), tableSpoonMeasure));
        tacoRecipe.getIngredients().add(new Ingredient("dried oregano", new BigDecimal(1), teapoonMeasure));
        tacoRecipe.getIngredients().add(new Ingredient("dried cumin", new BigDecimal(1), teapoonMeasure));
        tacoRecipe.getIngredients().add(new Ingredient("sugar", new BigDecimal(1), teapoonMeasure));
        tacoRecipe.getIngredients().add(new Ingredient("salt", new BigDecimal(".5"), teapoonMeasure));
        tacoRecipe.getIngredients().add(new Ingredient("clove of garlic, choppedr", new BigDecimal(1), pieceMeasure));
        tacoRecipe.getIngredients().add(new Ingredient("finely grated orange zestr", new BigDecimal(1), tableSpoonMeasure));
        tacoRecipe.getIngredients().add(new Ingredient("fresh-squeezed orange juice", new BigDecimal(3), tableSpoonMeasure));
        tacoRecipe.getIngredients().add(new Ingredient("olive oil", new BigDecimal(2), tableSpoonMeasure));
        tacoRecipe.getIngredients().add(new Ingredient("boneless chicken thighs", new BigDecimal(4), tableSpoonMeasure));
        tacoRecipe.getIngredients().add(new Ingredient("small corn tortillasr", new BigDecimal(8), pieceMeasure));
        tacoRecipe.getIngredients().add(new Ingredient("packed baby arugula", new BigDecimal(3), cupsMeasure));
        tacoRecipe.getIngredients().add(new Ingredient("medium ripe avocados, slic", new BigDecimal(2), pieceMeasure));
        tacoRecipe.getIngredients().add(new Ingredient("radishes, thinly sliced", new BigDecimal(4), pieceMeasure));
        tacoRecipe.getIngredients().add(new Ingredient("cherry tomatoes, halved", new BigDecimal(".5"), pintMeasure));
        tacoRecipe.getIngredients().add(new Ingredient("red onion, thinly sliced", new BigDecimal(".25"), pieceMeasure));
        tacoRecipe.getIngredients().add(new Ingredient("roughly chopped cilantro", new BigDecimal(4), pieceMeasure));
        tacoRecipe.getIngredients().add(new Ingredient("cup sour cream thinned with 1/4 cup milk", new BigDecimal(4), cupsMeasure));
        tacoRecipe.getIngredients().add(new Ingredient("lime, cut into wedges", new BigDecimal(4), pieceMeasure));
